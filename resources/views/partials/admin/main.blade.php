...
<head>
    ...
    <title>{{ $title }}</title>
    <link rel="icon" href="{{ asset('assets/dist/img/polresta.png') }}" type="image/x-icon">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('assets/dist/img/polresta.png') }}" alt="AdminLTELogo"
                height="60" width="60">
        </div>
